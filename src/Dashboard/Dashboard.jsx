...
function Dashboard() {
    ...
    return (
        <>
            <HeroSection title={"Manager Control Panel"} text={"Manage your voting system's candidates, decisions, and sessions"} />
            <div className="dashboard-container">
                <div className="container">
                    <div className="row justify-content-center align-items-center gap-5">
                        ...
                        <DashboardCards title={"Manage Elections"} desc={"Control active voting elections"} icon={faClock} link={"/manage-elections"} />
                        <DashboardCards title={"Manager Settings"} desc={"Configure system settings and permissions"} icon={faGear} link={"/manage-users"} />
                    </div>
                </div>
            </div>
        </>
